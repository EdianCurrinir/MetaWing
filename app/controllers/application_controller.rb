  ...
  def ranking_configuration
    {
      ...
      use_ranking_data:            params['use_ranking_data'].blank?            ? 'all'                : params['use_ranking_data'],
      ranking_start:               params['ranking_start'].blank?               ? 1.month.ago.to_date  : params['ranking_start'],
      ranking_end:                 params['ranking_end'].blank?                 ? Time.current.to_date : params['ranking_end'],
